...
const theme = definePreset(Nora, {
  ...
  semantic: {
    ...
    focusRing: {
      ...
      color: "{primary.color}",
      offset: "3px",
      shadow: "0 0 0 2px rgba(255, 90, 95, 0.2)",
    },
    disabledOpacity: "0.6",
    iconSize: "1rem",
    anchorGutter: "0",
    // Updated primary colors to match Airbnb-style design
    primary: {
      50: "#fff8f8",
      100: "#ffe5e6",
      200: "#ffd1d3",
      300: "#ffbdc0",
      400: "#ffa9ac",
      500: "#ff5a5f", // Main brand color - Airbnb-like
      600: "#ff4146",
      700: "#e63940",
      800: "#cc3239",
      900: "#b32b32",
    ...
    formField: {
      ...
      focusRing: {
        ...
        color: "{primary.500}",
        offset: "-1px",
        shadow: "0 0 0 3px rgba(255, 90, 95, 0.1)",
      },
      transitionDuration: "0.2s",
    },
    list: {
    ...
    // Updated overlay styling for modern look
    overlay: {
      select: {
        borderRadius: "{border.radius.md}",
    ...
    colorScheme: {
      light: {
        ...
        // More subtle backgrounds and shadows
        content: {
          background: "#ffffff",
          hoverBackground: "rgba(255, 90, 95, 0.04)",
