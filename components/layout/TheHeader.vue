<template>
  <header
    class="min-h-[40vh] flex flex-col items-center justify-center bg-gradient-to-b from-slate-50/95 to-white/80 backdrop-blur-md w-full relative border-b border-gray-200/80"
    role="banner"
  >
